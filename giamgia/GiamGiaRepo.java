      ...
      public ArrayList<GiamGia> getAllTrangThai( int trangThai) {
        String sql = """
                    SELECT
                        ...
                        ,[ngay_ket_thuc]
                        ,[trang_thai]
                    FROM [dbo].[GiamGiaHoaDon] where [trang_thai]=?""";
       ...
       public GiamGia checkTrung(String maCheck) {
        ...
        String sql = """
                     SELECT [id]
                           ...
                           ,[ngay_ket_thuc]
                           ,[trang_thai]
                       FROM [dbo].[GiamGiaHoaDon] where ma_giam_gia=?
                     """;
    ...
    public ArrayList<GiamGia> search(String maVC) {
        String sql = """
         SELECT [id]
                ...
                ,[ngay_ket_thuc]
                ,[trang_thai]
            FROM [dbo].[GiamGiaHoaDon]  where ma_giam_gia like ?""";
